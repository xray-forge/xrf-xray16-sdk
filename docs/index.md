...
features:
  - title: Engine types
    details:
      Declarations for engine globals, luabind classes, UI and GOAP classes, script objects, and readable aliases.
    link: /guide/engine-types
  - title: TypeScriptToLua plugins
    details:
      Opt-in build transforms — luabind class emission, macro folding, constant inlining, log stripping, lib bundling,
      Tracy zones.
    link: /plugins/
